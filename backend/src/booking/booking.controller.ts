...
import {
  Serialize,
  SerializeBookingDto,
} from '../global/interceptors/serialize.interceptor';
...
export class BookingController {
  ...
  requestDocuments(
    ...
    return this.bookingDocumentsService.requestDocuments(
      documentsStepRequest,
      profile,
    );
  }
  ...
  @UseGuards(JwtGuard)
  panelArtistBookings(
    @Param('signature') artistSignature: string,
    @GetProfile() profile: JwtPayload,
  ) {
